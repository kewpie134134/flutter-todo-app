...
import 'package:flutter_todo_app/components/todo_edit/todo_edit_view.dart';
...
class TodoListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Providerを設定する。listen: falseにより、こちらはビルドされない。
    final _bloc = Provider.of<TodoBloc>(context, listen: false);

    return Scaffold(
      appBar: AppBar(title: Text(ConstText.todoListView)),
      body: StreamBuilder<List<Todo>>(
        stream: _bloc.todoStream, // 変更があるとここだけ再描画してくれる
